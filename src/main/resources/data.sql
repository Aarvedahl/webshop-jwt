insert into app_user(userid,firstname,username,password) values (1,'John Doe','admin','admin');
insert into app_user(userid,firstname,username,password) values (2,'Liza Elizabeth','user','user');
