...
public class Purchase implements Serializable{
    ...
    public Purchase() { }
    public Purchase(int orderid, AppUser userid, Date orderdate, Boolean canceled) {
        this.orderid = orderid;
        this.userid = userid;
    ...
    public Purchase(Date orderdate, boolean canceled, AppUser userid) {
        this.orderdate = orderdate;
        this.canceled = canceled;
        this.userid = userid;
    }
    ...
    public AppUser getUserid() { return userid; }
    public void setUserid(AppUser userid) { this.userid = userid; }
